...
SKILLCARD_FLASHCARD_FREQ = {
    ...
    "(A)スタンドプレー+ ♡-5": "* パラメータ+12 __**元気**__+7\n* __**集中**__+7\n* __**消費体力増加**__2ターン\n* __**重複不可**__",
    "(A)シュプレヒコール ♡0": "* __**集中**__消費3\n* パラメータ+6\n* __**好調**__2ターン\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(A)シュプレヒコール+ ♡0": "* __**集中**__消費2\n* パラメータ+6\n* __**好調**__3ターン\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(A)立ち位置チェック ♡0": "* __**集中**__消費3\n* パラメータ+25 __**元気**__+15\n* __**元気増加無効**__2ターン\n* __**レッスン中1回**__",
    ...
    "(A)みんな大好き ♡0": "* __**やる気**__消費3\n* __**好印象**__の90%分パラメータ上昇\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(A)みんな大好き+ ♡0": "* __**やる気**__消費2\n* __**好印象**__の120%分パラメータ上昇\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    ...
    "(M)意地 ♡-2": "* __**元気**__+3\n* __**集中**__+4\n* __**レッスン中1回**__",
    "(M)意地+ ♡-2": "* __**元気**__+5\n* __**集中**__+5\n* __**レッスン中1回**__",
    "(M)存在感 ♡0": "* __**好調**__消費2ターン\n* __**集中**__+4\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(M)存在感+ ♡0": "* __**好調**__消費1ターン\n* __**集中**__+5\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(M)成功への道筋 ♡0": "* __**好調**__消費2ターン\n* __**元気**__+2\n* __**集中**__+7\n* __**レッスン中1回**__",
    "(M)成功への道筋+ ♡0": "* __**好調**__消費2ターン\n* __**元気**__+4\n* __**集中**__+9\n* __**レッスン中1回**__",
    ...
    "(M)ゆめみごこち ♡0": "* __**好印象**__消費2\n* __**やる気**__+4\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(M)ゆめみごこち+ ♡0": "* __**好印象**__消費1\n* __**やる気**__+5\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(M)止められない想い ♡-4": "* __**体力**__消費4\n* __**やる気**__+3\n* __**好印象**__+3\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)止められない想い+ ♡-4": "* __**体力**__消費4\n* __**やる気**__+4\n* __**好印象**__+5\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)オトメゴコロ ♡0": "* __**やる気**__消費3\n* __**好印象**__+4\n* __**スキルカード使用数追加**__+1\n* __**重複不可**__",
    "(M)オトメゴコロ+ ♡0": "* __**やる気**__消費3\n* __**好印象**__+5\n* __**スキルカード使用数追加**__+1\n* __**好印象**__が10以上の場合、__**好印象**__+2\n* __**重複不可**__",

    # SSR Active
    "(A)コール＆レスポンス ♡-6": "* パラメータ+15*\n __**集中**__が3以上の場合、パラメータ+15\n* __**レッスン中1回**__ __**重複不可**__",
    "(A)コール＆レスポンス+ ♡-6": "* パラメータ+15*\n __**集中**__が3以上の場合、集中が3以上の場合、パラメータ+34（__**集中**__効果を1.5倍適用）\n* __**レッスン中1回**__ __**重複不可**__",
    ...
    "(A)至高のエンタメ ♡0": "* __**集中**__消費3\n* 以降、__**アクティブスキルカード**__使用時、パラメータ+4\n* __**レッスン中1回**__ __**重複不可**__",
    "(A)至高のエンタメ+ ♡0": "* __**集中**__消費2\n* 次のターン、スキルカードを引く\n* 以降、__**アクティブスキルカード**__使用時、パラメータ+5\n* __**レッスン中1回**__ __**重複不可**__",
    "(A)覚醒 ♡0": "* __**好調**__消費1ターン\n* パラメータ+3（2回）\n* __**集中**__+4\n* __**重複不可**__",
    "(A)覚醒+ ♡0": "* __**好調**__消費1ターン\n* パラメータ+4（2回）\n* __**集中**__+6\n* __**重複不可**__",
    ...
    "(M)国民的アイドル ♡0": "* __**好調**__消費1ターン\n* 次に使用するスキルカードの効果をもう1回発動（1回）\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)国民的アイドル+ ♡0": "* __**好調**__消費1ターン\n* __**元気**__+8\n* 次に使用するスキルカードの効果をもう1回発動（1回）\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)魅惑の視線 ♡0": "* __**集中**__消費3\n* __**絶好調**__4ターン\n* __**消費体力減少**__2ターン\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)魅惑の視線+ ♡0": "* __**集中**__消費3\n* __**絶好調**__5ターン\n* __**消費体力減少**__5ターン\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)鳴り止まない拍手 ♡-5": "* __**集中**__+4\n* __**好調**__2ターン\n* __**消費体力減少**__2ターン\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)鳴り止まない拍手+ ♡-5": "* __**集中**__+5\n* __**好調**__3ターン\n* __**消費体力減少**__3ターン\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)天真爛漫 ♡-6": "* __**集中**__+1\n* 以降、ターン終了時、__**集中**__が3以上の場合、__**集中**__+2\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)天真爛漫+ ♡-3": "* __**集中**__+1\n* 以降、ターン終了時、__**集中**__が3以上の場合、__**集中**__+2\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)私がスター ♡0": "* __**好印象**__消費2\n* __**ターン追加**__+1\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)私がスター+ ♡0": "* __**好印象**__消費1\n* __**ターン追加**__+1\n* __**スキルカード使用数追加**__+1\n* スキルカードを引く\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)星屑センセーション ♡0": "* __**やる気**__消費3\n* __**好印象**__+5\n* __**スキルカード使用数追加**__+1\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)星屑センセーション+ ♡0": "* __**やる気**__消費3\n* __**好印象**__+7\n* __**スキルカード使用数追加**__+1\n* スキルカードを引く\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)ノートの端の決意 ♡-4": "* __**好印象**__+3\n* __**やる気**__+3\n* __**消費体力減少**__3ターン\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)ノートの端の決意+ ♡-4": "* __**好印象**__+5\n* __**やる気**__+3\n* __**消費体力減少**__3ターン\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)手書きのメッセージ ♡0": "* __**好印象**__消費2\n* __**元気**__+9\n* __**元気**__+9\n* __**レッスン中1回**__ __**重複不可**__",
    "(M)手書きのメッセージ+ ♡0": "* __**好印象**__消費1\n* __**元気**__+10\n* __**元気**__+10\n* __**レッスン中1回**__ __**重複不可**__",
